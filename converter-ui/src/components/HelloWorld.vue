  ...
  <div class="hello">
    ...
    <form>
      ...
      <input
              ...
              class="field"
      >
      <button type="button" @click="propertySelected">Convert number</button>
    </form>
...
export default {
  ...
  methods: {
    propertySelected(event) {
      console.warn("button clicked! " + this.numberToConvert + " " + event);
      // const property = {
      //     name: event.name,
      //     title: event.title
      // }
      ...
      GeneralService.convertNumberToWords(this.numberToConvert)
              ...
              .catch(error => {
                console.log(error);
                this.numberInWords = 'An error occurred: ' + error;
              });
    }
  }
